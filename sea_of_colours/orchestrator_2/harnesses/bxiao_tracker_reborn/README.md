> ### This directory is yours — BXIAO_TRACKER_REBORN
>
...
```44:75:sea_of_colours/orchestrator_2/harnesses/bxiao_tracker_reborn/orbit_policy.py
...
```43:43:sea_of_colours/orchestrator_2/harnesses/bxiao_tracker_reborn/_v7/chat_schema.py
...
Prefer changing `bxiao_tracker_reborn/` proper; touch `_v7/` only for shared
...
| --- | --- | --- |
| `BXIAO_TRACKER_REBORN_SINGLE` | `0` | `1` skips the THINK/PLAN split — one LLM call, faster, dumber |
| `BXIAO_TRACKER_REBORN_AUTOFILL` | `0` | `1` lets the packager top up a short plan |
