"""bxiao_tracker_reborn — OUT-OF-GRID KNOWLEDGE: what you can SENSE but cannot SEE.
...
from sea_of_colours.orchestrator_2.harnesses.bxiao_tracker_reborn.world_view import (
    _live_rows,
    _my_probe_cells,
    _tier,
)
