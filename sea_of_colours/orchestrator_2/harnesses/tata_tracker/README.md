> ### This directory is yours — TATA_TRACKER
>
...
```44:75:sea_of_colours/orchestrator_2/harnesses/tata_tracker/orbit_policy.py
...
```43:43:sea_of_colours/orchestrator_2/harnesses/tata_tracker/_v7/chat_schema.py
...
Prefer changing `tata_tracker/` proper; touch `_v7/` only for shared
...
| --- | --- | --- |
| `TATA_TRACKER_SINGLE` | `0` | `1` skips the THINK/PLAN split — one LLM call, faster, dumber |
| `TATA_TRACKER_AUTOFILL` | `0` | `1` lets the packager top up a short plan |
